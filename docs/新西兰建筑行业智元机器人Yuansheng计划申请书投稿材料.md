...
<img src="figs/drywall_sim/03_carry_board.png" alt="智元 Genie G2 搬运石膏板仿真截图">
<img src="figs/drywall_sim/05_fasten_left_column.png" alt="智元 Genie G2 装订固定点仿真截图">
</div>
<p class="cover-caption"><em>团队已完成的前期准备工作:基于智元 Genie G2 与 Isaac Sim 的石膏板搬运与装订仿真验证(完整证据见第 3.1 节)</em></p>

---

## 材料对照(《Project-Approval Form》四维度)

| 维度 | 对应内容 | 章节 |
| --- | --- | --- |
| 客户(Customer) | BBCNZL(已确认示范客户)、奥克兰交通局 AT(已有初步接触、拟推进) | 第一、四节 |
| 场景(Scenario) | 内墙板/石膏板(GIB®)装订(首发,Task Deployment Mode)及六项规划扩展工序 | 第三节 |
| 方案(Solution) | 机器人技术研发方案、合规证据链、数据采集/模型优化/测试 Pipeline | 第五、六、八节 |
| 伙伴能力(Partner Capability) | 团队构成与分工、已完成的智元 Genie G2 仿真验证证据 | 第一节、第 3.1 节 |

---

## 一、项目团队及主要成员

本项目团队采用"Lead 统筹执行 + 建筑行业合作伙伴 + 学术牵头人 + 智元新西兰项目团队"的四方协作架构:

> **马博博士(Lead)+ Louis(建筑行业合作伙伴,BBCNZL) + Wei Qi Yan(牵头人) + Hunter Shao / 王思维 Siwei Wang / Rex Xu(智元机器人新西兰项目团队)**
...
### 3. 牵头人:Associate Professor Wei Qi Yan
...
### 4. 智元机器人新西兰项目团队:Hunter Shao / 王思维 Siwei Wang / Rex Xu

Hunter Shao 深耕通信和自动化行业三十多年,积累丰厚的项目经验;王思维 和 Rex Xu 同样负责智元机器人新西兰项目;Hunter Shao,王思维 和 Rex Xu 担任本项目核心技术负责人之一,负责机器人平台技术路线、智元机器人软硬件接口协调、系统集成、应用场景设计和产品落地工作。三人共同构成本项目对接智元机器人总部、机器人平台技术集成与新西兰本地市场的执行团队,主要职责包括:

- 智元机器人设备、SDK、API 及运动控制接口的获取与技术对接;
- 智元机器人总部与本项目团队之间的沟通协调;
- 参与机器人产品总体架构设计,推动机器人本体、传感器、控制系统和 AI 软件集成,协调机器人平台测试、功能验证和问题解决;
- Yuansheng 计划投稿材料准备、里程碑申报(MS1/MS2/MS3)及规模化阶段权益的执行落地;
- 新西兰本地代理商体系、设备交付与售后支持的组织协调;
- 参与新西兰建筑行业需求分析和应用场景设计,协助建设机器人演示、测试和应用环境;
- 面向新西兰建筑行业客户与 AT 的产品展示、现场验证组织。

Hunter Shao 在通信和自动化行业的工程与产品化背景,有助于本项目在设备工程化落地、系统集成和产业化交付节奏方面与智元机器人总部高效对接;王思维重点连接智元机器人平台能力、本地代理商资源和新西兰建筑行业需求,确保科研工作能够与机器人产品能力和市场实际需求有效结合。

### 团队互补优势

本项目形成"Lead 统筹执行 + 建筑行业一线验证 + 学术牵头与科研质量 + 智元总部资源对接与机器人平台技术"的四方互补结构:
...
- **Hunter Shao / 王思维 Siwei Wang / Rex Xu(智元新西兰项目团队)**主要负责:智元机器人及代理商技术协调;机器人平台接口和系统集成;Yuansheng 计划里程碑申报与规模化权益执行;设备、平台和工程资源组织;产品展示、行业验证和商业化协同。
...
### 1. 多工序施工能力与新西兰建筑全流程合规证据链集成(PS1–PS4 / CCC)

项目将围绕建筑全流程各工序,重点研发**分工序合规证据生成能力**:将装订间距/固定力度、框架连接件固定质量、防水层覆盖与搭接、瓷砖平整度、管线间距与坡度、钢筋间距与浇筑记录等过程数据,与对应工序的新西兰建筑规范可量化参数进行实时比对与结构化记录,形成按工序区分、可追溯的施工过程证据链,并与第八节所述的 PS1–PS4 / CCC 体系逐工序对应。
...
项目将研发机器人不确定性评估、安全停止、风险控制和人工确认机制,核心目标是保护建筑工地工人以及 AT 停车场巡检场景中行人和车辆的人身安全——这是本项目建筑工地与 AT 停车巡检两个场景共同的关键安全能力。当机器人遇到目标识别置信度不足、工作区域突然出现人员、任务指令存在歧义、传感器数据相互矛盾、环境与训练数据存在明显差异、无法确认物体是否可以抓取、当前动作可能造成人身或设备风险、网络中断或关键服务不可用、运动路径被临时障碍物阻挡、设备状态与预期状态不一致等情况时,不应盲目执行动作,而应根据风险程度选择暂停操作、降低运动速度、重新观察和判断、请求人工确认、切换至安全模式、返回安全位置、终止当前任务、记录事件并生成报告。
...
针对建筑工地及交通基础设施现场——尤其是 AT 停车场巡检场景中车牌、车辆和人员影像的处理——项目将研究端侧图像和视频处理、人脸及人员身份信息保护、敏感区域自动模糊、数据最小化采集、非必要视频不上传云端、本地事件摘要生成、操作日志和 AI 决策审计、不同用户的数据访问权限、数据生命周期和删除机制,确保系统设计符合新西兰《隐私法 2020》及数据管理要求。
...
机器人在各工序生成的结构化过程证据(第五节第 1 条),按上表工序—证明书对应关系,分别辅助承包商、LBP 或工程师出具 PS3/PS4,并可汇总为标准化证据包,辅助最终提交 Building Consent Authority 的 CCC 申请材料;最终签署与审批决定权始终在具备法定资质的人员和 Building Consent Authority 手中。
...
立项通过后,本项目获得的全部资金将用于采购智元远征 A3 机器人,作为后续现场调试和 POC 验证阶段的实体机器人平台,支持在 BBCNZL 示范工地开展真实环境下的装订任务测试与迭代。
...
- 建立以新西兰建筑工程机器人为代表的、可复用于其他西方国家(欧洲、北美、澳新等地区,因建筑标准相似且与中国市场差异较大)轻型建筑市场的标准化任务解决方案;
...
本项目将由马博博士担任 Lead,统筹项目技术实施与 Yuansheng 计划投稿执行;Yan 院士担任项目学术牵头人和首席研究员。在 Lead 与牵头人共同领导下:Hunter Shao / 王思维 Siwei Wang / Rex Xu 负责智元机器人总部对接、机器人平台技术路线与系统集成、Yuansheng 计划里程碑执行和市场推广;Louis / BBCNZL 提供建筑行业实际需求、施工工艺、合规实务和现场验证环境。各方将共同构建从科研、平台开发、行业验证到 Yuansheng 计划商业化里程碑的完整机器人创新体系,推动智元机器人在新西兰建筑行业与奥克兰交通局相关场景中建立长期、可持续且具有技术竞争力的产业基础。
